...
from Data.make_augmentation import MakeAugmentation
from Data.training_dataset import make_dataset
from Data.test_dataset_split import Testset_split, val_test_dataset
# from Few_Shot_data import Few_Shot

from Data.testset_maker import testset
# from tokenizing import Set_Dataset_to_Token
from Data.dataset_processor import processors_mapping, num_labels_mapping, output_modes_mapping, compute_metrics_mapping  #  median_mapping
        ...
        if args.active_log:
            ...
            if args.data_augmentation:
                wandb.init(
                    ...
                    project = f"VQ-{args.dataset}-Finetuning-renewal-ver2",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-test-result', type = str, default = f'{os.getcwd()}/test_result_roberta_eda', help = 'save model path [model_file | model_file]')
    ...
    parser.add_argument('--augmentation', type = str, default = 'EDA', help = 'VQ_TEGAN | GAN | EDA')  # choose the augmentation method
    parser.add_argument('--few-shot-type', type = str, default = 'finetune', help = 'finetune')
    parser.add_argument('--gan-latent-dim', type = int, default = 100, help = '100')

    parser.add_argument('--num-aug', type = int, default = 4, help = '4|9')
    args = parser.parse_args()

    greedy_search(args.greedy, args, 'EDA-Finetuning', Test_training)  # VQ-Finetuning | GAN-Finetuning | EDA-Finetuning
