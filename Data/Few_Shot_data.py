...
from Benchmark_methodology.EDA_method import eda_4
...
class Few_Shot(Dataset):
    ...
    def forward(self, args, train_eval = None):
        ...
        if args.augmentation == 'EDA' and train_eval == 'train':
            self.few_shot_data = eda_4(sentences = self.few_shot_data, num_aug=args.num_aug)
